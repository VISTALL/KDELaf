...
/**
 * Class QRadioButtonMenuItemUI
 * RadioButtonMenuItemUI for KDE look & feel.
 * 
 * @author Sekou DIAKITE (diakite_at_freeasinspeech_dot_org)
 */
public class QRadioButtonMenuItemUI extends QMenuItemUI implements MouseListener {
	/** True when the rollover is active. */
	protected boolean rollover = false;
		
	/**
	 * Returns an instance of <code>QRadioButtonMenuItemUI</code>.
	 * @return an instance of <code>QRadioButtonMenuItemUI</code>.
	 */
	public static ComponentUI createUI(JComponent c)  {
		return new QRadioButtonMenuItemUI();
	}
   ...
   */
	...
	protected void paintBackground(Graphics g, JMenuItem menuItem, Color bgColor) {
		try {
			BufferedImage img = KdeLAF.getClient().getRadioButtonMenuItemImage(menuItem, rollover);
